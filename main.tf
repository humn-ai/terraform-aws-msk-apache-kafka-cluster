...
resource "aws_msk_cluster" "default" {
  ...
  broker_node_group_info {
    ...
    security_groups = var.use_existing_security_groups ? var.existing_security_groups : concat(distinct(var.additional_security_groups, aws_security_group.default.*.id))
  }
